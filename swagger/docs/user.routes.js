 ...
 *     description: Admin có thể xem tất cả users trong hệ thống để quản lý và CRUD
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 * /api/user/admin/{id}:
 *   get:
 *     summary: Get user by ID (Admin only) - CRUD Account
 *     description: Admin có thể xem chi tiết một user cụ thể
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   put:
 *     summary: Update user role (Admin only) - CRUD Account
 *     description: Admin có thể thay đổi role của bất kỳ user nào (trừ chính mình). Có thể chỉ định account nào sẽ trở thành Teacher.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                 message:
 *                   type: string
 *                   example: "Cannot change your own role from Admin"
 *                 validRoles:
 *                   type: array
 *                   items:
 *                     type: string
 ...
 *   delete:
 *     summary: Delete user (Admin only) - CRUD Account
 *     description: Admin có thể xóa bất kỳ user nào (trừ chính mình)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
